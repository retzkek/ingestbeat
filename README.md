...
`${GOPATH}/src/github.com/retzkek/ingestbeat`
...
```
git remote set-url origin https://github.com/retzkek/ingestbeat
...
```
mkdir -p ${GOPATH}/src/github.com/retzkek/ingestbeat
git clone https://github.com/retzkek/ingestbeat ${GOPATH}/src/github.com/retzkek/ingestbeat
```
